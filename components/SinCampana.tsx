...
export default function SinCampana() {
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-5 md:p-8 text-center mb-6">
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-4">
          {[
            ...
            <div key={i} className="bg-[#111] border border-[#1a1a1a] rounded-xl p-2 md:p-4 text-center">
              <div className="text-2xl mb-2">{v.icon}</div>
              <p className="text-[10px] text-yellow-400 leading-snug break-words hyphens-auto">{v.txt}</p>
            </div>
          ))}
        </div>
      </div>
