      ...
      <body className={`${syne.variable} ${dmSans.variable} bg-black text-white antialiased`}>
        <nav className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-900 bg-black/90 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <span className="font-syne font-bold text-xl text-white">Land<span className="text-orange-500">Copy</span></span>
            <div className="flex items-center gap-6 text-sm text-zinc-400">
              ...
              <a href="/precios" className="hover:text-orange-500 transition-colors font-medium">Precios</a>
            </div>
          </div>
        </nav>
