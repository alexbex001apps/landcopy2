...
3. SOCIAL PLANNER (antes "R.IA"): el módulo ESTRATÉGICO de redes. La IA actúa como Director de Marketing y diseña una campaña completa con calendario, formatos, narrativa y carruseles. Tiene 3 modos según qué promociona el usuario: Producto, Negocio local, y Marca personal (para autores, músicos, pastores, coaches — los que son su propia marca).
