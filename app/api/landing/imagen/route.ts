...
export async function POST(req: NextRequest) {
  try {
    ...
    const ACENTOS: Record<string, string> = {
      naranja: "vibrant orange",
      lavanda: "soft lavender purple",
      azul: "bright electric blue",
      verde: "vivid emerald green",
      amarillo: "bright golden yellow",
      rosa: "hot pink",
