          ...
          <>
            ...
            {cargando ? (
              ...
              <div className="space-y-2">
                <button onClick={descargar} className="w-full bg-purple-500 hover:bg-purple-600 text-white text-sm font-bold py-4 rounded-xl transition-colors">⬇ Descargar video</button>
                <button onClick={generar} className="w-full bg-[#111] border border-purple-500/30 text-purple-300 text-sm font-bold py-3 rounded-xl active:scale-95 transition-transform">↻ Generar otro</button>
              </div>
            ) : (
